					...
					<div class="row">
						<div class="col-xl-10 offset-xl-1 col-lg-10 offset-lg-1 col-xs-12">
							<div class="page-hero-content">
								<h1 class="page-title">Login or Register Account</h1>
							</div>
						</div>
					</div>
				</div>
...
?>
							<div class="box-message box-message-error">
								...
								<div class="row">
                                    ...
                                    <form action="reg_lg.php" method="post" >
										<!--<form action="https://www.cssigniter.com/" class="form-login">-->
											<h3>Login</h3>
											
											<div class="form-field">
												<label for="username-login">Email-id</label>
												<input type="text" id="eid" name="eid" value="" required>
											</div>

											<div class="form-field">
												<label for="username-password">Password</label>
												<input type="password" id="pd" name="pd" value="" required>
											</div>
									...
									<div class="col-lg-6 col-xs-12">
										<form action="reg_insert.php" class="form-register" method="post" enctype="multipart/form-data">
											<h3>Register</h3>

											<div class="form-field">
												<label for="email-register">E-mail</label>
												<input type="email" id="e_id" name="e_id" required>
											</div>
											...
											<div class="form-field">
                                                ...
                                                <input type="submit" class="login" id="lg" value="Register" onClick="return mail_chk()"/>
											</div>
										</form>
